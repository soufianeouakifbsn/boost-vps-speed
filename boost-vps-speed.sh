...
net.ipv4.udp_wmem_max = 1073741824  # رفع سرعة الرفع للحد الأقصى!
...
ethtool -s $IFACE speed 10000 duplex full autoneg off  # ضبط سرعة البطاقة إلى 10Gbps!

# تعزيز سرعة الرفع عبر UDP
echo "🔥 رفع سرعة الرفع عبر UDP إلى الحد الأقصى!"
ethtool -G $IFACE tx 1048576  # رفع المخزن المؤقت للإرسال
